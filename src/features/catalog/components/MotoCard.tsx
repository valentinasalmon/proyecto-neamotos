...
/**
 * MotoCard – Uniforme, parejo y GRANDE (rápido en catálogo)
 * - Marco 4:3 fijo (sin reacomodo)
 * - <img> normal (sin canvas) => navegación fluida
 */
export function MotoCard({ moto }: { moto: MotoItem }) {
  const src = useMemo(() => moto.img || "/motos/_no-image.png", [moto.img]);

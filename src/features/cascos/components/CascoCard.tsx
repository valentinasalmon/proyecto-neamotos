...
export function CascoCard({ item }: { item: CascoItem }) {
  return (
    ...
    >
      ...
      {/* IMAGEN */}
      <div className="relative w-full aspect-[5/4] bg-white overflow-hidden flex items-center justify-center border-b border-neutral-200 p-3 sm:p-4">
      ...
      <div className="px-4 sm:px-5 pt-4 pb-6">
        <div className="grid grid-cols-2 gap-y-2 gap-x-6">
          <div>
            <p className="text-[11px] sm:text-[12px] uppercase font-semibold text-neutral-700 tracking-wide">
              PESO
            </p>
            <p className="text-[14px] sm:text-[15px] text-neutral-900 font-medium leading-tight mt-0.5">
              {item.peso}
            </p>
          </div>
      ...
      {/* BOTÓN WHATSAPP — MISMO SVG, SOLO CAMBIA LA POSICIÓN */}
      <a

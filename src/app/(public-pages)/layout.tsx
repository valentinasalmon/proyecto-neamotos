...
// estilos globales: ahora viven en /src/styles
import "@/styles/global.css";
import "@/styles/theme.css";

// React Query Provider: lo movimos a core/lib/queryClient.ts
  ...
  return (
    <html lang="es" className={`${display.variable} ${body.variable} font-body`}>
      <body className="bg-black text-white antialiased">
        {/* HEADER */}
        <header className="fixed inset-x-0 top-0 z-30 backdrop-blur bg-white/70 border-b border-gray-100 text-black">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <nav
              className="hidden md:flex items-center gap-6 text-sm font-semibold text-black"
